...
/******/ 	var hotCurrentHash = "df6c31fe25d2ab72822b"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _interopRequireDefault = __webpack_require__(170)['default'];
	...
	var _viewGameJsx = __webpack_require__(172);

	var _viewGameJsx2 = _interopRequireDefault(_viewGameJsx);

	/*eslint-enable no-unused-vars*/

	_reactDom2['default'].render(_react2['default'].createElement(_viewGameJsx2['default'], null), document.getElementById('app'));

	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(208); if (makeExportsHot(module, __webpack_require__(66))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "index.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _get = __webpack_require__(173)['default'];

	var _inherits = __webpack_require__(189)['default'];

	var _createClass = __webpack_require__(198)['default'];
	...
	var _GridJsx = __webpack_require__(202);

	var _GridJsx2 = _interopRequireDefault(_GridJsx);

	var _NotificationJsx = __webpack_require__(214);

	var _NotificationJsx2 = _interopRequireDefault(_NotificationJsx);

	/*eslint-enable no-unused-vars*/

	var _underscore = __webpack_require__(217);

	var _underscore2 = _interopRequireDefault(_underscore);

	var _utilGAME_CONSTANTSJs = __webpack_require__(218);

	var _utilGAME_CONSTANTSJs2 = _interopRequireDefault(_utilGAME_CONSTANTSJs);
	...
	var Game = (function (_Component) {
	    ...
	    function Game() {
	        ...
	        _get(Object.getPrototypeOf(Game.prototype), 'constructor', this).apply(this, args);
	        this.state = {
	            msg: 'Click on New Game to begin',
	            newGame: true,
	            currentPlayer: 1,
	            winner: '',
	            boardState: _underscore2['default'].clone(_utilGAME_CONSTANTSJs2['default'].NEW_GAME_BOARD_STATE)
	        };
	    }
	    ...
	    _createClass(Game, [{
	        ...
	        value: function handleButtonClick() {
	            var msg = 'Lets go Player 1';
	            var boardState = _underscore2['default'].clone(_utilGAME_CONSTANTSJs2['default'].NEW_GAME_BOARD_STATE);
	            this.setState({
	                newGame: true,
	                winner: '',
	                currentPlayer: 1,
	        ...
	        key: 'onPlay',
	        value: function onPlay(lastPlayed, clickedSquare, boardState) {
	            var userChoice = lastPlayed === 1 ? 'X' : 'O';
	            ...
	            var _checkWinner = this.checkWinner(boardState, lastPlayed);

	            var winner = _checkWinner.winner;
	            var winCondition = _checkWinner.winCondition;
	        ...
	        key: 'checkWinner',
	        value: function checkWinner(boardState, currentPlayer) {
	            var winner = '';
	            var horizontalWin = undefined;
	            var verticalWin = undefined;
	            var diagonalWin = undefined;
	            var winCondition = undefined;
	            ...
	            var isDraw = winner === '' && _underscore2['default'].every(boardState, function (choice) {
	                return choice !== '';
	            });
	            return {
	        ...
	        value: function render() {
	            ...
	            var winCondition = this.state.winCondition;

	            var handleButtonClick = this.handleButtonClick.bind(this);
	            var onPlay = this.onPlay.bind(this);

	            return _react2['default'].createElement(
	                'div',
	                { className: 'game' },
	                _react2['default'].createElement(_NotificationJsx2['default'], { msg: msg }),
	                _react2['default'].createElement(_GridJsx2['default'], { newGame: newGame, winner: winner, winCondition: winCondition, currentPlayer: currentPlayer, boardState: boardState, onPlay: onPlay }),
	                _react2['default'].createElement(
	                    'button',
	                    { className: 'btn-new-game', onClick: handleButtonClick },
	                    ' Start Game '
	                )
	            );
	        }
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(208); if (makeExportsHot(module, __webpack_require__(66))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Game.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$getOwnPropertyDescriptor = __webpack_require__(174)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SquareJsx = __webpack_require__(203);
	...
	var Grid = (function (_Component) {
	    ...
	    _createClass(Grid, [{
	        key: 'getGrid',
	        value: function getGrid(currentPlayer, winner) {
	            ...
	            for (var i = 0; i < 9; i++) {
	                ...
	                var onSquareClick = this.props.onPlay.bind(this, currentPlayer, i, boardState);

	                if (i % 3 === 0) {
	                    square = _react2['default'].createElement(_SquareJsx2['default'], { key: i, onSquareClick: onSquareClick, userChoice: userChoice, disable: disable, firstSquare: true });
	                    squares.push(square);
	                } else {
	                    square = _react2['default'].createElement(_SquareJsx2['default'], { key: i, onSquareClick: onSquareClick, userChoice: userChoice, disable: disable });
	                    squares.push(square);
	                }
	            }
	            return squares;
	        ...
	        value: function render() {
	            ...
	            var squares = this.getGrid(currentPlayer, winner);
	            var winCondition = this.props.winCondition;
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement('div', { className: 'grid-border-1' }),
	                    _react2['default'].createElement('div', { className: 'grid-border-2' }),
	                    _react2['default'].createElement('div', { className: 'grid-border-3' }),
	                    _react2['default'].createElement('div', { className: 'grid-border-4' })
	                ),
	                _react2['default'].createElement(
	                    'div',
	                    { className: (0, _classnames2['default'])('strike-winner', winCondition) },
	                    _react2['default'].createElement('div', { className: (0, _classnames2['default'])('strikeout', { 'win': winner && winCondition }) })
	                ),
	                squares
	            );
	        }
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(208); if (makeExportsHot(module, __webpack_require__(66))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Grid.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Square = (function (_Component) {
	    ...
	    function Square() {
	        ...
	        _get(Object.getPrototypeOf(Square.prototype), 'constructor', this).apply(this, args);
	    }

	    _createClass(Square, [{
	        key: 'render',
	        value: function render() {
	            var userChoice = this.props.userChoice;
	            var firstSquare = this.props.firstSquare;
	            var isDisabled = this.props.disable;
	            var onSquareClick = !isDisabled ? this.props.onSquareClick : '';
	            var userChoiceElem = userChoice === 'X' ? _react2['default'].createElement(
	                'span',
	                { className: 'red-color' },
	                userChoice
	            ) : _react2['default'].createElement(
	            ...
	            return firstSquare ? _react2['default'].createElement(
	                'div',
	                { className: 'square square--first', onClick: onSquareClick },
	                userChoiceElem
	            ) : _react2['default'].createElement(
	                'div',
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(208); if (makeExportsHot(module, __webpack_require__(66))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Square.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isReactClassish = __webpack_require__(209),
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".grid {\n  width: 180px;\n  height: 180px;\n  margin: 50px auto 0; }\n  .grid .grid-borders {\n    position: relative;\n    width: 100%; }\n  .grid .grid-border-1 {\n    border-left: 2px solid #000000;\n    height: 180px;\n    position: absolute;\n    left: 58px;\n    top: 0; }\n  .grid .grid-border-2 {\n    border-left: 2px solid #000000;\n    height: 180px;\n    position: absolute;\n    left: 118px;\n    top: 0; }\n  .grid .grid-border-3 {\n    border-bottom: 2px solid #000000;\n    width: 180px;\n    position: absolute;\n    left: 0;\n    top: 58px; }\n  .grid .grid-border-4 {\n    border-bottom: 2px solid #000000;\n    width: 180px;\n    position: absolute;\n    left: 0;\n    top: 118px; }\n  .grid .strike-winner {\n    position: relative;\n    width: 100%;\n    top: 0;\n    left: 0; }\n    .grid .strike-winner.first-column {\n      transform: rotate(90deg);\n      left: -60px;\n      top: 90px; }\n    .grid .strike-winner.second-column {\n      transform: rotate(90deg);\n      left: 0px;\n      top: 90px; }\n    .grid .strike-winner.third-column {\n      transform: rotate(90deg);\n      left: 60px;\n      top: 90px; }\n    .grid .strike-winner.first-row {\n      top: 30px; }\n    .grid .strike-winner.second-row {\n      top: 90px; }\n    .grid .strike-winner.third-row {\n      top: 150px; }\n    .grid .strike-winner.left-diagonal {\n      transform: rotate(45deg);\n      left: -30px;\n      top: 90px;\n      width: 135%; }\n    .grid .strike-winner.right-diagonal {\n      transform: rotate(135deg);\n      left: -31px;\n      top: 90px;\n      width: 135%; }\n  .grid .strikeout {\n    position: absolute;\n    width: 0;\n    left: 0;\n    top: 0;\n    border-bottom: 3px dotted #000088; }\n    .grid .strikeout.win {\n      transition: width 1s;\n      width: 100%; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Notification = (function (_Component) {
	    ...
	    function Notification() {
	        ...
	        _get(Object.getPrototypeOf(Notification.prototype), 'constructor', this).apply(this, args);
	    }
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(208); if (makeExportsHot(module, __webpack_require__(66))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "Notification.jsx" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (true) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = __webpack_require__(208); if (makeExportsHot(module, __webpack_require__(66))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "GAME_CONSTANTS.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)(module)))
